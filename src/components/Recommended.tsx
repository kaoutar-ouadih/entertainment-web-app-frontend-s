...
const Recommended: React.FC<RecommendedProps> = ({copyOfData, bookmarkedItems, setBookmarkedItems}) => {
  ...
  return (
    <div className="px-7">
        <h1 className="text-white text-3xl font-extralight mb-7">Recommended for you</h1>
